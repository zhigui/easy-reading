...
var analysic, analysicTitle, analysisParagraphs, bodyHtml, getTitle, node, nodeIndex, paragraphs, targetDiv, titleEl, toptitle;
...
analysicTitle = function(t) {
  ...
  return t.titleScore.score += Number(style['font-size'].match(/\d+/)[0]);
};
